        ...
        <div class="maint-card-footer" style="width: 100%; display: flex; justify-content: space-between; align-items: center; padding-top: 12px; border-top: 1px solid rgba(255,255,255,0.05);">
          ...
          <div style="display:flex; gap: 8px;">
            ${issue.status === 'Reported' ? `
              <button type="button" class="submit-btn" style="padding: 6px 14px; font-size:0.75rem; margin-top:0; height: auto; background: var(--primary);" onclick="handleStartTask('${issue.id}')">🚀 Start</button>
